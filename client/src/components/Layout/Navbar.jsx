...
import { selectCurrentUser, selectIsAdmin, clearCredentials } from '../../features/auth/authSlice';
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              <>
                <Link to="/bookings/my-bookings" className="hover:text-blue-200 transition">
                  Мои бронирования
                </Link>
              ...
              <>
                ...
                {isAdmin && (
                  <>
                    ...
                    <div className="font-semibold py-1 text-blue-200">Админ-панель:</div>
